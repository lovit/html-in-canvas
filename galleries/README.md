...
| # | 예제 | 배우는 것 |
| --- | --- | --- |
| 01 | `01-hello-world` | `layoutSubtree`, `drawElementImage()`, `paint` 이벤트의 최소 조합 |
| 02 | `02-draw-geometry` | 위치와 크기 인자, 소스 사각형, 캔버스 변환 행렬과의 관계 |
| 03 | `03-interactive-form` | 반환된 `DOMMatrix` 로 클릭과 포커스, 접근성 살리기 |
